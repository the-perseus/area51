...
def logbook():
    ...
    if form.validate_on_submit():
        ...
        newlogentry = Logbooktable(location=form.location.data, time=form.time.data, depth=form.depth.data, temperature=form.temperature.data)
        #und in die DB damit
        ...
        showlogbook = Logbooktable.query.order_by(Logbooktable.id)
